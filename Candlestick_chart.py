...
share = 'AMZN'
t = round(time.time())
url = f'https://query1.finance.yahoo.com/v7/finance/download/{share}?period1={t - 31536000}&period2={t}&interval=1d&events=history&includeAdjustedClose=true'
...
mpf.plot(df, type='candle', mav=10, volume=True, tight_layout=True)
